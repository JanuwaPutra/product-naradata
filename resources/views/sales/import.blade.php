    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-2">
            <h5 class="card-title mb-0 fw-semibold">
                <i class="fas fa-file-import me-1 text-primary"></i> Import Data Penjualan
            </h5>
        </div>
        <div class="card-body p-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card border bg-light bg-opacity-50 mb-3">
                        <div class="card-body p-3">
                            ...
                            <ol class="ps-3 mb-0">
                                ...
                                <li>Pastikan nama barang sesuai dengan yang ada di database.</li>
                                <li>Pastikan stok barang mencukupi untuk penjualan.</li>
                                <li>Format tanggal: YYYY-MM-DD (contoh: 2023-12-31).</li>
                    ...
                    <div class="d-grid">
                        <a href="{{ route('sales.template') }}" class="btn btn-outline-primary">
